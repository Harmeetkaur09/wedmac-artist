...
useEffect(() => {
  ...
  function handleMessage(e: MessageEvent) {
    ...
    // Accept only token payloads or other known types
    if (e.data && (e.data.access || e.data.accessToken || e.data.type === "token-ack")) {
      processTokenData(e.data);
    } else {
      console.warn("🔸 Received message (ignored):", e.data);
    }
  }
