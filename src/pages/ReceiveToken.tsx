...
function handleMessage(e: MessageEvent) {
  ...
  if (window.opener && e.source !== window.opener) {
    console.warn("🔸 Ignored: sender is not the opener (probably an extension/other script).", e.origin, e.data);
    return;
  }
  ...
  if (!e.data || typeof e.data !== "object") {
    console.warn("🔸 Ignored non-object message (likely internal/extension):", e.data);
    return;
  }
