...
const allMenuItems = [
  ...
  { title: "Unlocked Leads", url: "/leads", icon: Unlock, requiresPlan: true },
  { title: "Reported Leads", url: "/reported-leads", icon: Flag, requiresPlan: true },
  { title: "Wedmac Plans", url: "/plans", icon: Crown },
  { title: "Assigned Lead", url: "/assigned", icon: Check, requiresPlan: true },
  { title: "Wedmac Shop", url: "/shop", icon: ShoppingBag },
  { title: "Refer & Earn", url: "/refer", icon: Share2, requiresPlan: true },
